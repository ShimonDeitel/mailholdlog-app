...
struct ContentView: View {
    ...
    @State private var editingEntry: HoldEntry?
...
struct EntryFormView: View {
    ...
    var body: some View {
        NavigationStack {
            Form {
                DatePicker("Hold Start Date", selection: $date, displayedComponents: .date)
    ...
    private func save() {
        switch mode {
        case .add:
            let entry = HoldEntry(date: date, itemName: itemName, notes: notes)
            store.add(entry)
